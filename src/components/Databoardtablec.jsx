...
export function Databoardtablec() {
  ...
  const [lo, setLo] = useState([
    {"date": "Jun 25, 2022","fuelType":"Petrol","vehicleType":"2-wheller","distance":200},
    {"date": "Jun 25, 2022","fuelType":"Petrol","vehicleType":"2-wheller","distance":200},
    {"date": "Jun 26, 2022","fuelType":"Petrol","vehicleType":"2-wheller","distance":200},
    {"date": "Jun 27, 2022","fuelType":"Petrol","vehicleType":"2-wheller","distance":200},
    {"date": "Jun 28, 2022","fuelType":"Petrol","vehicleType":"2-wheller","distance":200},
          ...
          {[...lo].map((item, idx) => {
            return (
              <tr key={idx} className="databoardtable__tabletr">
                ...
                <td className="databoardtable__tabletd">{item.distance}&nbsp;kms</td>
              </tr>
            );
          })}
        </tbody>
        ...
        <div style={{
          ...
          showInput ? (
            <div style={{fontSize: "14px"}}>
              ...
              />
              Enter Type Of Fuel 
              <input type={"text"} value={fuelType} style={{
                appearance: 'none',
                border: 'solid 0.5px',
                padding:"8px",
                margin: "0px 8px 16px 8px",
              ...
              <br/>
              Enter Vehicle Type
              <input type={"text"} value={vehicleType} style={{
                appearance: 'none',
                border: 'solid 0.5px',
                padding:"8px",
                margin: "0px 8px 16px 8px",
              ...
              <input type={"number"} value={distance} style={{
                appearance: 'none',
                border: 'solid 0.5px',
                padding:"8px",
                margin: "0px 8px 16px 8px",
            ...
            <button id="addButton" style={{
              ...
              onClick={() => {
                ...
                `*/
                if(distance > -1 && distance !== "" && dates !== ""&& vehicleType!== "" && fuelType!== ""){
                  ...
                  setLo([...lo,{"date": formattedDate,"fuelType":fuelType,"vehicleType":vehicleType,"distance":distance}]);
                  setShowInput(false)
                }
              }}
              >Add Row</button></div>
